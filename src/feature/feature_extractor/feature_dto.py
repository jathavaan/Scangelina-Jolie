...
class FeatureDto:
    ...
    def __init__(self, eigenvalues: np.ndarray, z: np.ndarray, logger: ILogger) -> None:
        ...
        self.array = np.array([
            ...
            self.linearity, self.planarity, self.scattering,
            self.omnivariance, self.sum_of_eigenvalues, self.eigenentropy,
            self.anisotropy, self.change_of_curvature, self.z_range
        ])
